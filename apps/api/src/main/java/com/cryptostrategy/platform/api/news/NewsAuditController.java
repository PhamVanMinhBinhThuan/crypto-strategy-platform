...
public class NewsAuditController {
    ...
    public record AuditResponse(String sentimentResultId,String newsId,String language,String contentHash,String modelName,String modelVersion,String preprocessingVersion,String contractVersion,String label,String confidence,String polarityScore,Instant analyzedAt){}
}
