...
final class BacktestTestFixture {
    ...
    ResolvedBacktestRun command(int batch){return new ResolvedBacktestRun(new ExperimentId("0000000000000000000000000A"),new CandidateId("0000000000000000000000000B"),new JobId("0000000000000000000000000C"),new AttemptId("0000000000000000000000000D"),dataset,new BacktestProvenance("manifest","dataset","strategy"),BacktestAssumptions.mvp(BigDecimal.valueOf(1000),new BigDecimal("0.001"),new BigDecimal("0.001")),batch,3);}
