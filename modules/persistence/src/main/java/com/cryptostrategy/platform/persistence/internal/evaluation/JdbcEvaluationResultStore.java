...
public final class JdbcEvaluationResultStore implements EvaluationResultStore {
    ...
    @Override public EvaluationResult save(EvaluationResult result){return tx.execute(s->{
        ...
        try{insert(result);return result;}catch(DuplicateKeyException conflict){EvaluationResult canonical=findCanonical(result);if(canonical==null)throw conflict;return equivalent(canonical,result);}
    });}
