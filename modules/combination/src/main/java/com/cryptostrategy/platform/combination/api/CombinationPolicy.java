...
public interface CombinationPolicy { CombinationPolicyReference reference(); StrategySignal combine(List<StrategyDecision> decisions, StrategyParameterSet parameters); }
