...
| --- | --- | --- | --- |
| F-006 deterministic Backtest/Evaluation/Leaderboard | Batch size, assumptions, metric/ranking version và tie-break | Look-ahead, liên kết chéo Experiment, kết quả không tái tạo được | Planned — unit/architecture tests đã chạy trên feature branch; SQL/JDBC evidence chờ isolated test database |
