...
> Failure isolation không có nghĩa là không bao giờ có lỗi. Nó có nghĩa lỗi được giới hạn trong dependency path của nó. Sentiment down thì News chưa có kết quả mới, nhưng Market chart và Technical Backtest vẫn chạy; Worker crash thì Job/Attempt còn trong storage để recovery.
